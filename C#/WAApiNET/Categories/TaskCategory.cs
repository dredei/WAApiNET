...
namespace WAApiNET.Categories
{
    ...
    public class TaskCategory
    {
        ...
        /// <returns></returns>
        public async Task DeleteTask( int folderId, int taskId )
        {
            await this.DeleteTasks( folderId, new[] { taskId } );
        }
        ...
        /// <param name="task">Задание</param>
        /// <returns></returns>
        public async Task DeleteTask( WAFolder folder, WATask task )
        {
            await this.DeleteTasks( folder, new[] { task } );
        }
        ...
        /// <param name="targetFolderId">Папка назначения</param>
        /// <param name="taskId">Id задания</param>
        /// <returns></returns>
        public async Task MoveTask( int sourceFolderId, int targetFolderId, int taskId )
        {
            await this.MoveTasks( sourceFolderId, targetFolderId, new[] { taskId } );
        }
